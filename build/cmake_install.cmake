...
if(NOT CMAKE_INSTALL_LOCAL_ONLY)
  ...
  include("/scratch/04950/dhl/SWAT/swatplus_predocker/build/_deps/json-c-build/cmake_install.cmake")
endif()
...
if("x${CMAKE_INSTALL_COMPONENT}x" STREQUAL "xUnspecifiedx" OR NOT CMAKE_INSTALL_COMPONENT)
  ...
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/bin" TYPE EXECUTABLE FILES "/scratch/04950/dhl/SWAT/swatplus_predocker/build/bin/swatplus_exe")
  if(EXISTS "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/bin/swatplus_exe" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/bin/swatplus_exe")
    file(RPATH_CHANGE
         FILE "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/bin/swatplus_exe"
         OLD_RPATH "/scratch/04950/dhl/SWAT/swatplus_predocker/build/_deps/json-c-build:"
         NEW_RPATH "")
...
file(WRITE "/scratch/04950/dhl/SWAT/swatplus_predocker/build/${CMAKE_INSTALL_MANIFEST}"
     "${CMAKE_INSTALL_MANIFEST_CONTENT}")
